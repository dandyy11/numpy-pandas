...
print("-----------------------------------------------   STEP TWO   -----------------------------------------------")
min_sale = salesArray.min()
max_sale = salesArray.max()
...
print("-----------------------------------------------   STEP THREE  -----------------------------------------------")
sales_over_100 = salesArray >= 100
print(sales_over_100)
print()

## Step 4: Print the total sales for each register.
print("-----------------------------------------------   STEP FOUR   -----------------------------------------------")
total_sales_per_register = salesArray.sum(axis=1)
...
print("-----------------------------------------------   STEP SEVEN  -----------------------------------------------")
second_and_fourth_sales = salesArray[[1, 3], :]
print(second_and_fourth_sales)
print()
...
updated_sales_array = np.vstack([salesArray, newRegister])
print(updated_sales_array)
print()
